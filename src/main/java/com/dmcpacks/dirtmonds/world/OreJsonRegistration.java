...
public class OreJsonRegistration {
    public static final RegistryKey<PlacedFeature> DIRTMOND_SMALL_ORE_PLACED_KEY = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Dirtmonds.MOD_ID,"dirtmond_ore_small"));
    public static final RegistryKey<PlacedFeature> DIRTMOND_MEDIUM_ORE_PLACED_KEY = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Dirtmonds.MOD_ID,"dirtmond_ore_medium"));
    public static final RegistryKey<PlacedFeature> DIRTMOND_LARGE_ORE_PLACED_KEY = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(Dirtmonds.MOD_ID,"dirtmond_ore_large"));
